...
<div class="py-12 px-6 h-full flex flex-col justify-content-between">
    <div class="h-min grid grid-cols-1 gap-4">
        <div class="flex justify-start gap-2 items-center font-medium p-2 @if($path == 'stock') bg-amber-500 @else text-black/70 hover:bg-amber-500 transition-colors duration-200 @endif rounded-lg group">
            <div>
    ...
    <div class="mt-auto">
        <div class="h-min grid grid-cols-1 gap-4">
            <div class="flex justify-start gap-2 items-center hover:bg-amber-500 p-2 transition-colors duration-200 rounded-lg group">
                ...
                <div class="group-hover:text-white transition-colors duration-200">Settings</div>
            </div>
